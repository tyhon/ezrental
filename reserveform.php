  ...
  <section class="menu cid-rSGemrEJWi" once="menu" id="menu1-d">
    ...
    <nav class="navbar navbar-dropdown navbar-fixed-top collapsed">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav-dropdown navbar-nav-top-padding" data-app-modern-menu="true"><li class="nav-item"><a class="nav-link link text-black display-4" href="index.html"><br><br>Home<br></a></li><li class="nav-item"><a class="nav-link link text-black display-4" href="page1.html">Login/Signup<br></a></li><li class="nav-item"><a class="nav-link link text-black display-4" href="page2.html">Get Quote<br></a></li><li class="nav-item"><a class="nav-link link text-black display-4" href="page3.html">About Us</a></li><li class="nav-item"><a class="nav-link link text-black display-4" href="page4.html">Contact Us<br><br></a></li></ul>
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-xs-12">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" id="end_date" type="date" name="end_date" placeholder="End Date" required=""><br>    
                                    </div>
                                </div>

                                <div class="form-group col-xs-12">
                                    <label for="fname"><span class="text-danger" style="margin-right: 5px; float:left;">*</span> First Name: </label>
                                    <div class="input-group">
                                        <input class="form-control" id="fname" type="text" name="fname" placeholder="First Name" required="" autofocus="">       
                                    </div>
                                </div>
                           
                                <div class="form-group col-xs-12">
                                    <label for="email"><span class="text-danger" style="margin-right: 5px;float:left;">*</span> Email: </label>
                                    <div class="input-group">
                                        <input class="form-control" id="email" type="text" name="email" placeholder="Email" required=""><br>    
                                    </div>
                                </div>
                
                                <div class="form-group col-xs-12">
                                    <label for="size_car">Car Size: <span class="text-danger" style="margin-right: 5px;">*</span></label>
                                    <select id="size_car">
                                ...
                                <div class="form-group col-xs-12">
                                    <label for="make_car"><span class="text-danger" style="margin-right: 5px;">*</span> Manufacturer: </label>
                                    <div class="input-group">
                                        <input class="form-control" id="make_car" type="text" name="make_car" placeholder="asdf" required="" autofocus="">       
                                    </div>
                                </div>
                           
                                <div class="form-group col-xs-12">
                                    <label for="model_car"><span class="text-danger" style="margin-right: 5px;">*</span> Model: </label>
                                    <div class="input-group">
                                        <input class="form-control" id="model_car" type="text" name="model_car" placeholder="asdf" required="">    
                                    </div>
                                </div>

                                <div class="form-group col-xs-12">
                                    <label for="color_car"><span class="text-danger" style="margin-right: 5px;">*</span> Color: </label>
                                    <div class="input-group">
                                        <input class="form-control" id="color_car" type="text" name="color_car" placeholder="asdf" required="">    
                                    </div>
                                </div>
