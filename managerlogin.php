                        ...
                        <form action="" method="POST">
                            ...
                            <div class="row">
                                <div class="form-group col-xs-12">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" id="man_username" type="text" name="man_username" placeholder="Username" required="" autofocus="">
                            ...
                            <div class="row">
                                <div class="form-group col-xs-12">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" id="man_password" type="password" name="man_password" placeholder="Password" required="">
