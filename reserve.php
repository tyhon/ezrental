                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="row">
                                <div class="form-group col-xs-12">
                                <label for="make_car">Car Make: <span class="text-danger" style="margin-right: 5px; float:left;">*</span></label>
                                    <select id="make_car">
                                ...
                                <div class="form-group col-xs-12">
                                <label for="model_car">Car Model: <span class="text-danger" style="margin-right: 5px; float:left;">*</span></label>
                                    <select id="model_car">
                                        <option value="volvo">Volvo</option>
                                        <option value="saab">Saab</option>
                                        <option value="mercedes">Mercedes</option>
