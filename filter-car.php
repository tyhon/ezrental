<?php 
    ...
    if($_SERVER["REQUEST_METHOD"] = "POST")    {
        if(isset($_POST['submit']))   {
            $make = mysqli_real_escape_string($conn, $_POST["size_car"]);
            $start = mysqli_real_escape_string($conn, $_POST["start_date"]);
            $end = mysqli_real_escape_string($conn, $_POST["end_date"]);
            $sql = "SELECT car_ID FROM car WHERE car_size= ?";
            $sql1 = "INSERT INTO reservation (`res_rentstart_date`, `res_rentend_date`) VALUES (?,?)";
